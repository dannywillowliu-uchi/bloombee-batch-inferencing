...
class RemoteSequential(nn.Module):
    ...
    def inference_session(self, **kwargs) -> InferenceSession:
        ...
        :param batch_size: Number of identical sequences to process in batch (default: 1)
        """
        batch_size = kwargs.pop("batch_size", 1)
        max_length = kwargs.get("max_length", 1024)
        
        with InferenceSession(self.sequence_manager, max_length=max_length, batch_size=batch_size) as session, self.use_session(session):
            yield session
